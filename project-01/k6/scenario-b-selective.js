...
export default function () {
  ...
  const restRes = http.get("http://localhost:8080/api/measurements/selective", {
    tags: { protocol: "rest" },
  });
  ...
  const grpcRes = grpcClient.invoke("SensorService/GetSelectiveData", {
    limit: 50,
  });
